...
exports.setLatestRun = function (job_id, run_id) {
	...
	var latest = runPath + '/' + 'latest';
	if (Fs.existsSync(latest)) {
		//console.log('removing previous latest link');
        Fs.unlinkSync(latest);
        Fs.symlinkSync(runIdPath, latest);
	}
	else {
        Fs.symlinkSync(runIdPath, latest);
	}
...
exports.getLatestRun = function (job_id) {
	var runPath = internals.defaults.mainPath + '/' + internals.defaults.jobPath + '/' + job_id + '/' + internals.defaults.runPath;
	var runIdPath = runPath + '/' + run_id;
	var latest = runPath + '/' + 'latest';
	var namePath = Fs.readlinkSync(latest);
