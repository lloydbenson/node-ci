...
exports.getJobs = function () {
    ...
    var jobs = internals.getDirs(jobPath);
    return jobs;
};
...
exports.getRuns = function (job_id) {
    ...
    var runs = internals.getDirs(runPath);
    return runs;
};

exports.saveJobConfig = function(job_id, config) {
   ...
   if (job_id == null) {
       ...
       jobPath = internals.defaults.mainPath + '/' + internals.defaults.jobPath + '/' + job_id;
       if (!Fs.exists(internals.defaults.mainPath + '/' + internals.defaults.jobPath + '/' + config.name)) {
           Fs.symlinkSync(jobPath, internals.defaults.mainPath + '/' + internals.defaults.jobPath + '/' + config.name);
       }
   }
