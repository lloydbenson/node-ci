...
exports.register = function (plugin, options, next) {
    ...
    plugin.route([
        ...
        { method: 'POST', path: settings.api.basePath+'/job', config: { handler: Api.createJob, description: "create job" } },
        { method: 'POST', path: settings.api.basePath+'/job/{job_id}', config: { handler: Api.updateJob, description: "update job" } },
