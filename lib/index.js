...
exports.register = function (plugin, options, next) {
    ...
    plugin.route([
        ...
        { method: 'GET', path: settings.basePath+'/job/id/run/id', config: { handler: Api.getJobStatus, description: "get job status" } },
        { method: 'GET', path: settings.basePath+'/job/id/run/id/cancel', config: { handler: Api.cancelJob, description: "cancel run" } },
